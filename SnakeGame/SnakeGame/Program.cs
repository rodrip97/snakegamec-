...
namespace JustSnake
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                food = new Position(
                    randomNumbersGenerator.Next(0, Console.WindowHeight), randomNumbersGenerator.Next(0,
                        Console.WindowWidth));
            }
            ...
            while (true)
            {
                    ...
                    || obstacles.Contains(snakeNewHead))
                {
                    ...
                    int userPoints =
                        (snakeElements.Count - 6) * 100 - negativePoints;
                ...
                if (snakeNewHead.col == food.col && snakeNewHead.row == food.row)
                {
                    ...
                    {
                        food = new Position(
                            randomNumbersGenerator.Next(0,Console.WindowHeight), randomNumbersGenerator.Next(0,Console.WindowWidth));
                    }
                    while (snakeElements.Contains(food) || obstacles.Contains(food));
                    lastFoodTime = Environment.TickCount;
                    Console.SetCursorPosition( food.col, food.row);
                    ...
                    while (snakeElements.Contains(obstacle) ||obstacles.Contains(obstacle) ||(food.row != obstacle.row && food.row != obstacle.row));
